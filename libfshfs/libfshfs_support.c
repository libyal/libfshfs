...
const char *libfshfs_get_version(
             void )
{
	return( (const char *) LIBFSHFS_VERSION_STRING );
}
...
int libfshfs_get_access_flags_read(
     void )
{
	return( (int) LIBFSHFS_ACCESS_FLAG_READ );
}
...
{
	static char *function = "libfshfs_get_codepage";
...
int libfshfs_set_codepage(
     ...
     libcerror_error_t **error )
{
	static char *function = "libfshfs_set_codepage";
     ...
     libcerror_error_t **error )
{
	...
	static char *function            = "libfshfs_check_volume_signature";
...
{
	libbfio_handle_t *file_io_handle = NULL;
	static char *function            = "libfshfs_check_volume_signature_wide";
	size_t filename_length           = 0;
	int result                       = 0;
     ...
     libcerror_error_t **error )
{
	...
	static char *function      = "libfshfs_check_volume_signature_file_io_handle";
	...
	if( read_count != 2 )
	{
		libcerror_error_set(
		 ...
		 "%s: unable to read signature at offset 1024 (0x00000400).",
		 function );
