...
#if !defined( _LIBFSHFS_LIBCTHREADS_H )
#define _LIBFSHFS_LIBCTHREADS_H

#include <common.h>

#if defined( HAVE_MULTI_THREAD_SUPPORT ) && !defined( HAVE_LOCAL_LIBFSHFS )
#define HAVE_LIBFSHFS_MULTI_THREAD_SUPPORT
#endif
...
#endif /* defined( HAVE_LIBFSHFS_MULTI_THREAD_SUPPORT ) */

#endif /* !defined( _LIBFSHFS_LIBCTHREADS_H ) */
