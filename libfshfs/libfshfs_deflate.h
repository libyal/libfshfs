...
typedef struct libfshfs_deflate_bit_stream libfshfs_deflate_bit_stream_t;

struct libfshfs_deflate_bit_stream
{
	/* The byte stream
	 */
...
typedef struct libfshfs_deflate_huffman_table libfshfs_deflate_huffman_table_t;

struct libfshfs_deflate_huffman_table
{
