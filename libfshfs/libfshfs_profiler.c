...
{
	static char *function = "libfshfs_profiler_initialize";
	...
	*profiler = memory_allocate_structure(
	...
	if( memory_set(
	     *profiler,
	     0,
	     sizeof( libfshfs_profiler_t ) ) == NULL )
	{
		libcerror_error_set(
		 error,
		 LIBCERROR_ERROR_DOMAIN_MEMORY,
...
int libfshfs_profiler_free(
     ...
     libcerror_error_t **error )
{
	static char *function = "libfshfs_profiler_free";
...
int libfshfs_profiler_open(
     ...
     libcerror_error_t **error )
{
	static char *function = "libfshfs_profiler_open";
	...
	if( fprintf(
	     ...
	     "timestamp,name,offset,size,duration,cache_hit_or_miss\n" ) <= -1 )
	{
		libcerror_error_set(
		 error,
		 LIBCERROR_ERROR_DOMAIN_IO,
...
int libfshfs_profiler_close(
     ...
     libcerror_error_t **error )
{
	static char *function = "libfshfs_profiler_close";
     ...
     libcerror_error_t **error )
{
	...
	static char *function = "libfshfs_profiler_start_timing";
     ...
     libcerror_error_t **error )
{
	...
	if( fprintf(
	     profiler->output_stream,
	     "%" PRIi64 ",%s,%" PRIi64 ",%" PRIu64 ",%" PRIi64 ",%s\n",
	     start_timestamp,
	     name,
	     offset,
	     size,
