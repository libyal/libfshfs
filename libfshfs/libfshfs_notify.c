...
{
	static char *function = "libfshfs_notify_set_stream";
...
int libfshfs_notify_stream_open(
     ...
     libcerror_error_t **error )
{
	static char *function = "libfshfs_notify_stream_open";
...
int libfshfs_notify_stream_close(
     libcerror_error_t **error )
{
	static char *function = "libfshfs_notify_stream_close";
