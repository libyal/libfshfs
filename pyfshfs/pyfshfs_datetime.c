           ...
           uint32_t micro_seconds )
{
	...
	static char *function     = "pyfshfs_datetime_new_from_time_elements";
...
{
	PyObject *datetime_object = NULL;
	static char *function     = "pyfshfs_datetime_new_from_fat_date_time";
	uint16_t year             = 0;
	uint8_t day_of_month      = 0;
	uint8_t days_in_month     = 0;
	uint8_t hours             = 0;
           ...
           uint64_t filetime )
{
	...
	datetime_object = pyfshfs_datetime_new_from_time_elements(
	                   year,
	                   filetime,
	                   hours,
	                   minutes,
           ...
           uint64_t floatingtime )
{
	...
	PyObject *datetime_object = NULL;
	static char *function     = "pyfshfs_datetime_new_from_floatingtime";
	uint32_t days_in_century  = 0;
	uint32_t micro_seconds    = 0;
	uint16_t days_in_year     = 0;
	uint16_t year             = 0;
