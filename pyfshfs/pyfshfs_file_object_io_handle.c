...
int pyfshfs_file_object_initialize(
     ...
     libcerror_error_t **error )
{
	pyfshfs_file_object_io_handle_t *file_object_io_handle = NULL;
	static char *function                                  = "pyfshfs_file_object_initialize";
	...
	if( pyfshfs_file_object_io_handle_initialize(
	     &file_object_io_handle,
	     file_object,
	     error ) != 1 )
	{
	...
	if( libbfio_handle_initialize(
	     ...
	     (int (*)(intptr_t **, libcerror_error_t **)) pyfshfs_file_object_io_handle_free,
	     (int (*)(intptr_t **, intptr_t *, libcerror_error_t **)) pyfshfs_file_object_io_handle_clone,
	     (int (*)(intptr_t *, int, libcerror_error_t **)) pyfshfs_file_object_io_handle_open,
	     (int (*)(intptr_t *, libcerror_error_t **)) pyfshfs_file_object_io_handle_close,
	     (ssize_t (*)(intptr_t *, uint8_t *, size_t, libcerror_error_t **)) pyfshfs_file_object_io_handle_read,
	     (ssize_t (*)(intptr_t *, const uint8_t *, size_t, libcerror_error_t **)) pyfshfs_file_object_io_handle_write,
	     (off64_t (*)(intptr_t *, off64_t, int, libcerror_error_t **)) pyfshfs_file_object_io_handle_seek_offset,
	     (int (*)(intptr_t *, libcerror_error_t **)) pyfshfs_file_object_io_handle_exists,
	     (int (*)(intptr_t *, libcerror_error_t **)) pyfshfs_file_object_io_handle_is_open,
	     (int (*)(intptr_t *, size64_t *, libcerror_error_t **)) pyfshfs_file_object_io_handle_get_size,
...
on_error:
	if( file_object_io_handle != NULL )
	{
		pyfshfs_file_object_io_handle_free(
		 &file_object_io_handle,
		 NULL );
	}
	return( -1 );
...
int pyfshfs_file_object_io_handle_free(
     ...
     libcerror_error_t **error )
{
	static char *function      = "pyfshfs_file_object_io_handle_free";
...
int pyfshfs_file_object_io_handle_clone(
     ...
     libcerror_error_t **error )
{
	static char *function = "pyfshfs_file_object_io_handle_clone";
...
int pyfshfs_file_object_io_handle_open(
     ...
     libcerror_error_t **error )
{
	static char *function = "pyfshfs_file_object_io_handle_open";
...
int pyfshfs_file_object_io_handle_close(
     ...
     libcerror_error_t **error )
{
	static char *function = "pyfshfs_file_object_io_handle_close";
         ...
         libcerror_error_t **error )
{
	...
	static char *function      = "pyfshfs_file_object_read_buffer";
...
ssize_t pyfshfs_file_object_io_handle_read(
         ...
         libcerror_error_t **error )
{
	static char *function      = "pyfshfs_file_object_io_handle_read";
	PyGILState_STATE gil_state = 0;
	ssize_t read_count         = 0;
	...
	read_count = pyfshfs_file_object_read_buffer(
	              file_object_io_handle->file_object,
	              buffer,
	              size,
	              error );
...
ssize_t pyfshfs_file_object_io_handle_write(
         ...
         libcerror_error_t **error )
{
	static char *function      = "pyfshfs_file_object_io_handle_write";
	PyGILState_STATE gil_state = 0;
	...
	write_count = pyfshfs_file_object_write_buffer(
	               file_object_io_handle->file_object,
	               buffer,
	               size,
	               error );
     ...
     libcerror_error_t **error )
{
	...
	PyObject *method_name     = NULL;
	PyObject *method_result   = NULL;
	static char *function     = "pyfshfs_file_object_seek_offset";
...
off64_t pyfshfs_file_object_io_handle_seek_offset(
         ...
         libcerror_error_t **error )
{
	static char *function      = "pyfshfs_file_object_io_handle_seek_offset";
	PyGILState_STATE gil_state = 0;
...
int pyfshfs_file_object_io_handle_exists(
     ...
     libcerror_error_t **error )
{
	static char *function = "pyfshfs_file_object_io_handle_exists";
...
int pyfshfs_file_object_io_handle_is_open(
     ...
     libcerror_error_t **error )
{
	static char *function = "pyfshfs_file_object_io_handle_is_open";
     ...
     libcerror_error_t **error )
{
	PyObject *method_name   = NULL;
	PyObject *method_result = NULL;
	static char *function   = "pyfshfs_file_object_get_size";
     ...
     libcerror_error_t **error )
{
	...
	else
	{
		     ...
		     error ) != 1 )
		{
			...
			pyfshfs_file_object_seek_offset(
			 file_object_io_handle->file_object,
			 current_offset,
			 SEEK_SET,
			 NULL );
