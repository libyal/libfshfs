...
PySequenceMethods pyfshfs_extended_attributes_sequence_methods = {
	/* sq_length */
	(lenfunc) pyfshfs_extended_attributes_len,
	/* sq_concat */
	0,
	/* sq_repeat */
	0,
	/* sq_item */
	(ssizeargfunc) pyfshfs_extended_attributes_getitem,
	/* sq_slice */
	0,
	/* sq_ass_item */
	0,
...
PyTypeObject pyfshfs_extended_attributes_type_object = {
	PyVarObject_HEAD_INIT( NULL, 0 )

	/* tp_name */
	"pyfshfs.extended_attributes",
	/* tp_basicsize */
	sizeof( pyfshfs_extended_attributes_t ),
	/* tp_itemsize */
	0,
	/* tp_dealloc */
	(destructor) pyfshfs_extended_attributes_free,
	/* tp_print */
	0,
	/* tp_getattr */
	0,
	...
	0,
	/* tp_as_sequence */
	&pyfshfs_extended_attributes_sequence_methods,
	/* tp_as_mapping */
	0,
	/* tp_hash */
	0,
	...
	/* tp_doc */
	"pyfshfs sequence and iterator object of extended attributes",
	/* tp_traverse */
	0,
	/* tp_clear */
	0,
	...
	0,
	/* tp_iter */
	(getiterfunc) pyfshfs_extended_attributes_iter,
	/* tp_iternext */
	(iternextfunc) pyfshfs_extended_attributes_iternext,
	/* tp_methods */
	0,
	/* tp_members */
	0,
	...
	0,
	/* tp_init */
	(initproc) pyfshfs_extended_attributes_init,
	/* tp_alloc */
	0,
	/* tp_new */
	0,
...
/* Creates a new extended attributes sequence and iterator object
...
PyObject *pyfshfs_extended_attributes_new(
           ...
           int number_of_items )
{
	pyfshfs_extended_attributes_t *sequence_object = NULL;
	static char *function                           = "pyfshfs_extended_attributes_new";
	...
	/* Make sure the extended attributes values are initialized
	 */
	sequence_object = PyObject_New(
	                   struct pyfshfs_extended_attributes,
	                   &pyfshfs_extended_attributes_type_object );
...
/* Initializes an extended attributes sequence and iterator object
 * Returns 0 if successful or -1 on error
 */
int pyfshfs_extended_attributes_init(
     pyfshfs_extended_attributes_t *sequence_object )
{
	static char *function = "pyfshfs_extended_attributes_init";
      ...
      pyfshfs_extended_attributes_t *sequence_object )
{
	...
	static char *function       = "pyfshfs_extended_attributes_free";
...
/* The extended attributes len() function
 */
Py_ssize_t pyfshfs_extended_attributes_len(
            pyfshfs_extended_attributes_t *sequence_object )
{
	static char *function = "pyfshfs_extended_attributes_len";
...
/* The extended attributes getitem() function
 */
           ...
           Py_ssize_t item_index )
{
	...
	static char *function               = "pyfshfs_extended_attributes_getitem";
	...
	extended_attribute_object = sequence_object->get_item_by_index(
...
/* The extended attributes iter() function
 */
PyObject *pyfshfs_extended_attributes_iter(
           pyfshfs_extended_attributes_t *sequence_object )
{
	static char *function = "pyfshfs_extended_attributes_iter";
...
/* The extended attributes iternext() function
 */
PyObject *pyfshfs_extended_attributes_iternext(
           pyfshfs_extended_attributes_t *sequence_object )
{
	PyObject *extended_attribute_object = NULL;
	static char *function               = "pyfshfs_extended_attributes_iternext";
