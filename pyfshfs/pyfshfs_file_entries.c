...
PySequenceMethods pyfshfs_file_entries_sequence_methods = {
	/* sq_length */
	(lenfunc) pyfshfs_file_entries_len,
	/* sq_concat */
	0,
	/* sq_repeat */
	0,
	/* sq_item */
	(ssizeargfunc) pyfshfs_file_entries_getitem,
	/* sq_slice */
	0,
	/* sq_ass_item */
	0,
...
PyTypeObject pyfshfs_file_entries_type_object = {
	PyVarObject_HEAD_INIT( NULL, 0 )

	/* tp_name */
	"pyfshfs.file_entries",
	/* tp_basicsize */
	sizeof( pyfshfs_file_entries_t ),
	/* tp_itemsize */
	0,
	/* tp_dealloc */
	(destructor) pyfshfs_file_entries_free,
	/* tp_print */
	0,
	/* tp_getattr */
	0,
	...
	0,
	/* tp_as_sequence */
	&pyfshfs_file_entries_sequence_methods,
	/* tp_as_mapping */
	0,
	/* tp_hash */
	0,
	...
	/* tp_doc */
	"pyfshfs sequence and iterator object of file entries",
	/* tp_traverse */
	0,
	/* tp_clear */
	0,
	...
	0,
	/* tp_iter */
	(getiterfunc) pyfshfs_file_entries_iter,
	/* tp_iternext */
	(iternextfunc) pyfshfs_file_entries_iternext,
	/* tp_methods */
	0,
	/* tp_members */
	0,
	...
	0,
	/* tp_init */
	(initproc) pyfshfs_file_entries_init,
	/* tp_alloc */
	0,
	/* tp_new */
	0,
...
PyObject *pyfshfs_file_entries_new(
           ...
           int number_of_items )
{
	pyfshfs_file_entries_t *sequence_object = NULL;
	static char *function                   = "pyfshfs_file_entries_new";
	...
	sequence_object = PyObject_New(
	                   ...
	                   &pyfshfs_file_entries_type_object );
...
{
	static char *function = "pyfshfs_file_entries_init";
      ...
      pyfshfs_file_entries_t *sequence_object )
{
	...
	static char *function       = "pyfshfs_file_entries_free";
...
Py_ssize_t pyfshfs_file_entries_len(
            pyfshfs_file_entries_t *sequence_object )
{
	static char *function = "pyfshfs_file_entries_len";
           ...
           Py_ssize_t item_index )
{
	...
	static char *function       = "pyfshfs_file_entries_getitem";
...
PyObject *pyfshfs_file_entries_iter(
           pyfshfs_file_entries_t *sequence_object )
{
	static char *function = "pyfshfs_file_entries_iter";
...
{
	PyObject *file_entry_object = NULL;
	static char *function       = "pyfshfs_file_entries_iternext";
