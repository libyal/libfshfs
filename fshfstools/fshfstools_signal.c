...
void (*fshfstools_signal_signal_handler)( fshfstools_signal_t ) = NULL;
...
{
	static char *function = "fshfstools_signal_handler";
	...
	switch( signal )
	{
		...
		case CTRL_C_EVENT:
			if( fshfstools_signal_signal_handler != NULL )
			{
				fshfstools_signal_signal_handler(
				 signal );
			}
			return( TRUE );
...
{
	static char *function = "fshfstools_signal_attach";
	...
	fshfstools_signal_signal_handler = signal_handler;

	if( SetConsoleCtrlHandler(
	     (PHANDLER_ROUTINE) fshfstools_signal_handler,
	     TRUE ) == 0 )
	{
		libcerror_error_set(
		 error,
...
#if defined( _MSC_VER )
	fshfstools_signal_initialize_memory_debug();
#endif
...
int fshfstools_signal_detach(
     libcerror_error_t **error )
{
	static char *function = "fshfstools_signal_detach";
	...
	fshfstools_signal_signal_handler = NULL;
