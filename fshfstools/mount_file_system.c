...
int mount_file_system_set_volume(
     mount_file_system_t *file_system,
     libfshfs_volume_t *fshfs_volume,
     libcerror_error_t **error )
{
	...
	file_system->fshfs_volume = fshfs_volume;
     ...
     libcerror_error_t **error )
{
	...
	*fshfs_volume = file_system->fshfs_volume;
