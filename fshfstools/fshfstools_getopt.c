                  ...
                  const system_character_t *options_string )
{
	...
	static char *function              = "fshfstools_getopt";
 ...
 */
void fshfstools_getopt_wrapped_fprint(
      FILE *stream,
 ...
 */
void fshfstools_getopt_usage_fprint(
      FILE *stream,
      const char *program,
      const char *description,
      const fshfstools_option_t *options,
      int number_of_options )
{
	const fshfstools_option_t *option   = NULL;
	...
	if( description != NULL )
	{
		...
		fshfstools_getopt_wrapped_fprint(
		 stream,
		 maximum_line_length,
		 0,
		 "",
 ...
 */
int fshfstools_getopt_get_options_string(
     const fshfstools_option_t *options,
     int number_of_options,
