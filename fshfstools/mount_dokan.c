...
int __stdcall mount_dokan_CreateFile(
               ...
               DWORD share_mode FSHFSTOOLS_ATTRIBUTE_UNUSED,
               DWORD creation_disposition,
               DWORD attribute_flags FSHFSTOOLS_ATTRIBUTE_UNUSED,
               DOKAN_FILE_INFO *file_info )
{
	...
	FSHFSTOOLS_UNREFERENCED_PARAMETER( share_mode )
	FSHFSTOOLS_UNREFERENCED_PARAMETER( attribute_flags )
...
NTSTATUS __stdcall mount_dokan_ZwCreateFile(
                    const wchar_t *path,
                    DOKAN_IO_SECURITY_CONTEXT *security_context FSHFSTOOLS_ATTRIBUTE_UNUSED,
                    ACCESS_MASK desired_access,
                    ULONG file_attributes FSHFSTOOLS_ATTRIBUTE_UNUSED,
                    ULONG share_access FSHFSTOOLS_ATTRIBUTE_UNUSED,
                    ULONG creation_disposition,
                    ULONG creation_options FSHFSTOOLS_ATTRIBUTE_UNUSED,
                    DOKAN_FILE_INFO *file_info )
{
	libcerror_error_t *error = NULL;
	...
	FSHFSTOOLS_UNREFERENCED_PARAMETER( security_context )
	FSHFSTOOLS_UNREFERENCED_PARAMETER( file_attributes )
	FSHFSTOOLS_UNREFERENCED_PARAMETER( share_access )
	FSHFSTOOLS_UNREFERENCED_PARAMETER( creation_options )
...
int __stdcall mount_dokan_GetFileInformation(
               const wchar_t *path,
               BY_HANDLE_FILE_INFORMATION *file_information,
               DOKAN_FILE_INFO *file_info FSHFSTOOLS_ATTRIBUTE_UNUSED )
#else
