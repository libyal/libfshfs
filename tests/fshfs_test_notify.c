...
/* Tests the libfshfs_notify_set_verbose function
 * Returns 1 if successful or 0 if not
 */
int fshfs_test_notify_set_verbose(
     void )
{
...
/* Tests the libfshfs_notify_set_stream function
 * Returns 1 if successful or 0 if not
 */
...
#endif
{
	...
	FSHFS_TEST_RUN(
	 "libfshfs_notify_set_verbose",
	 fshfs_test_notify_set_verbose )

	FSHFS_TEST_RUN(
	 "libfshfs_notify_set_stream",
	 fshfs_test_notify_set_stream )

	FSHFS_TEST_RUN(
	 "libfshfs_notify_stream_open",
	 fshfs_test_notify_stream_open )

	FSHFS_TEST_RUN(
	 "libfshfs_notify_stream_close",
	 fshfs_test_notify_stream_close )
