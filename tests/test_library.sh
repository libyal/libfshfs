...
LIBRARY_TESTS="attribute_record attributes_btree_key btree_file btree_header btree_node btree_node_descriptor btree_node_record buffer_data_handle catalog_btree_key compressed_data_handle compression deflate directory_entry directory_record error extent extents_btree_key file_entry file_record file_system fork_descriptor io_handle lzvn master_directory_block name notify profiler thread_record volume_header";
...
run_test()
{
	...
	local TEST_EXECUTABLE="./fshfs_test_${TEST_NAME}";
...
run_test_with_input()
{
	...
	local TEST_PROFILE_DIRECTORY=$(get_test_profile_directory "input" "libfshfs");
