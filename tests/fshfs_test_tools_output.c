...
#include "../fshfstools/fshfstools_output.h"

/* Tests the fshfstools_output_initialize and function
 * Returns 1 if successful or 0 if not
 */
int fshfs_test_tools_output_initialize(
     void )
{
	libcerror_error_t *error = NULL;
	int result               = 0;

	result = fshfstools_output_initialize(
	          _IONBF,
	          &error );
...
#endif
{
	...
	FSHFS_TEST_RUN(
	 "fshfstools_output_initialize",
	 fshfs_test_tools_output_initialize )

	/* TODO add tests for fshfstools_output_copyright_fprint */

	/* TODO add tests for fshfstools_output_version_fprint */

	/* TODO add tests for fshfstools_output_version_detailed_fprint */
