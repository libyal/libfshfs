...
Foreach (${TestName} in ${LibraryTests} -split " ")
{
	...
	$Result = RunTestBinary ${TestExecutablesDirectory} "fshfs_test_${TestName}"
...
Foreach (${TestName} in ${LibraryTestsWithInput} -split " ")
{
	...
	{
		$Result = RunTestBinaryWithInput ${TestExecutablesDirectory} "fshfs_test_${TestName}" ${TestInput}
