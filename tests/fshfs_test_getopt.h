...
#if !defined( _FSHFS_TEST_GETOPT_H )
#define _FSHFS_TEST_GETOPT_H
...
#define fshfs_test_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t fshfs_test_getopt(
                  int argument_count,
...
#endif /* !defined( _FSHFS_TEST_GETOPT_H ) */
